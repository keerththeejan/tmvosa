...
<footer class="site-footer" role="contentinfo">
    <div class="container-xxl">
        <div class="row g-4 gy-4 gx-4 site-footer-grid">
            <div class="col-12 col-md-6 col-lg-4 site-footer-col text-center text-md-start">
            ...
            <div class="col-12 col-lg-4 site-footer-col text-center text-md-start">
