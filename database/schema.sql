...
CREATE TABLE member_applications (
    ...
    payment_method VARCHAR(50) DEFAULT NULL COMMENT 'Allowed for new records: bank_transfer, cash',
...
CREATE TABLE payments (
    ...
    payment_method VARCHAR(50) NOT NULL COMMENT 'Allowed for new records: bank_transfer, cash',
    transaction_number VARCHAR(100) DEFAULT NULL,
