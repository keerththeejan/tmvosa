$('#memberForm').on('submit', function(e) {
    ...
    $.ajax({
        ...
        success: function(res) {
            if (res.success) {
                Swal.fire('Success', res.message || 'Member created.', 'success').then(function() {
                    window.location.href = BASE_URL + '/members/' + res.id;
                });
                return;
            }
            Swal.fire('Error', res.message || 'Could not create member.', 'error');
        },
        error: function(xhr) {
